    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        apiAdapter.apply {
            ...
            onClickItem = {
                ...
                //fragmentCallback?.onClickItem(if (it.couponUrls.sp.isNotEmpty()) it.couponUrls.sp else it.couponUrls.pc, it.id )
                //onClickItem?.invoke(if (it.couponUrls.sp.isNotEmpty()) it.couponUrls.sp else it.couponUrls.pc, it.id)
                fragmentCallback?.onClickItem(if (it.couponUrls.sp.isNotEmpty()) it.couponUrls.sp else it.couponUrls.pc, it.id, it.name, it.logoImage)
            }
        }
